...
- **GitHub Pages** : publier le dossier `01-vitrine-client` (fichiers `index.html` + `erp-shop.js` au même niveau).
- **Local** : ouvrir `index.html` dans un navigateur (double-clic) — l’API doit être déployée en accès public.
